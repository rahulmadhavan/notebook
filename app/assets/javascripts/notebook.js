...
function loadAssignments(folder_id){
    ...
    window.location= "assignments?folder_id="+folder_id
...
function fetchAssignmentsOnLoad(folder_id){
...
function loadRecords(assignment_id){
    ...
    window.location= "records?assignment_id="+assignment_id
...
function fetchRecordsOnLoad(assignment_id){
